# 雅思核心单词背诵应用 (IELTS Vocabulary App)

## 📱 项目简介

这是一个专为雅思考生设计的单词背诵Android应用程序，采用现代化的Material Design 3设计语言，提供科学高效的单词学习体验。

### ✨ 核心功能

- **📚 每日单词学习**: 可自定义每日学习单词数量（5-20个）
...
1. 编辑 `app/src/main/assets/ielts_words.json` 文件
2. 按照现有格式添加新的单词条目
3. 重新初始化数据或重新安装应用
